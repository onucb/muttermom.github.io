! function (e) {
    ...
    (function (e) {
        ...
        }, u.allSettled = o.a, u.resolve = function (e) {
    ...
    (function (e) {
        ...
        "function" != typeof i.Promise ? i.Promise = t.a : i.Promise.prototype.finally ? i.Promise.allSettled || (i.Promise.allSettled = o.a) : i.Promise.prototype.finally = r.a
    }).call(this, n(2))
}, function (e, t, n) {
    (function (e) {
    ...
    function b(e) {
        return e = y(e, [0, e[0] >>> 1]), e = y(e = h(e, [4283543511, 3981806797]), [0, e[0] >>> 1]), e = y(e = h(e, [3301882366, 444984403]), [0, e[0] >>> 1])
    }
                ...
                switch (i.label) {
                    ...
                    case 4:
                        return i.trys.push([4, , 10, 11]), [4, new Promise((function (e, n) {
                            ...
                            var a = l.style;
                            a.setProperty("display", "block", "important"), a.position = "absolute", a.top = "0", a.left = "0", a.visibility = "hidden", t && "srcdoc" in l ? l.srcdoc = t : l.src = "about:blank", o.body.appendChild(l);
                            var c = function () {
                                var e, t;
    ...
    function R(e) {
        for (var t = function (e) {
                for (var t, n, r = "Unexpected syntax '" + e + "'", o = /^\s*([a-z-]*)(.*)$/i.exec(e), i = o[1] || void 0, a = {}, c = /([.:#][\w-]+|\[.+?\])/gi, u = function (e, t) {
                        a[e] = a[e] || [], a[e].push(t)
                    };;) {
                    var l = c.exec(o[2]);
                    if (!l) break;
            ...
            function () {
                return o(e, void 0, void 0, (function () {
                    ...
                    return i(this, (function (t) {
                        switch (t.label) {
                            case 0:
                                return z(e = E()) ? _ ? [2, a(_)] : (n = document).fullscreenElement || n.msFullscreenElement || n.mozFullScreenElement || n.webkitFullscreenElement ? [4, M()] : [3, 2] : [3, 2];
                            case 1:
    ...
    function O(e) {
        ...
        return o(this, void 0, void 0, (function () {
            ...
            return i(this, (function (i) {
                switch (i.label) {
                    case 0:
                        for (n = document, r = n.createElement("div"), o = new Array(e.length), a = {}, D(r), s = 0; s < e.length; ++s) c = R(e[s]), D(l = n.createElement("div")), l.appendChild(c), r.appendChild(l), o[s] = c;
                        i.label = 1;
                    case 1:
    ...
    var ne = {
        fonts: function () {
            return Y((function (e, t) {
                ...
                return P.filter((function (e) {
                    return t = l[e], A.some((function (e, n) {
                ...
                return i(this, (function (i) {
                    switch (i.label) {
                        case 0:
                            ...
                            }, n = Object.keys(e), [4, O((a = []).concat.apply(a, n.map((function (t) {
                                return e[t]
                            }))))]) : [2, void 0];
                        case 1:
            ...
            return function (e, t) {
                ...
                return Y((function (n, r) {
                    var o = r.document,
                        i = o.body,
                        c = i.style;
                    c.width = t + "px", c.webkitTextSizeAdjust = c.textSizeAdjust = "none", F() ? i.style.zoom = "" + 1 / r.devicePixelRatio : x() && (i.style.zoom = "reset");
                                ...
                                try {
                                    switch (e.startRendering(), e.state) {
                                        case "running":
                                            ...
                                            break;
                                        case "suspended":
                                            document.hidden || l++, u && l >= t ? c(T("suspended")) : setTimeout(f, n)
                                    }
                                } catch (r) {
                                    c(r)
                                }
        ...
        languages: function () {
            ...
            if (void 0 !== r && n.push([r]), Array.isArray(t.languages)) F() && V([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || n.push(t.languages);
        ...
        indexedDB: function () {
            var e, t;
            if (!(j() || (e = window, t = navigator, V(["msWriteProfilerMark" in e, "MSStream" in e, "msLaunchUri" in t, "msSaveBlob" in t]) >= 3 && !j()))) try {
        ...
        platform: function () {
            ...
            return "MacIntel" === e && x() && !I() ? function () {
        ...
        canvas: function () {
            ...
            if (function (e, t) {
                ...
                var a = J(o);
                a !== J(o) ? e = t = "unstable" : (t = a, function (e, t) {
    ...
    function ie(e) {
        return function (e, t) {
            ...
            for (n = 0; n < o; n += 16) c = [255 & e.charCodeAt(n + 4) | (255 & e.charCodeAt(n + 5)) << 8 | (255 & e.charCodeAt(n + 6)) << 16 | (255 & e.charCodeAt(n + 7)) << 24, 255 & e.charCodeAt(n) | (255 & e.charCodeAt(n + 1)) << 8 | (255 & e.charCodeAt(n + 2)) << 16 | (255 & e.charCodeAt(n + 3)) << 24], u = [255 & e.charCodeAt(n + 12) | (255 & e.charCodeAt(n + 13)) << 8 | (255 & e.charCodeAt(n + 14)) << 16 | (255 & e.charCodeAt(n + 15)) << 24, 255 & e.charCodeAt(n + 8) | (255 & e.charCodeAt(n + 9)) << 8 | (255 & e.charCodeAt(n + 10)) << 16 | (255 & e.charCodeAt(n + 11)) << 24], c = v(c = h(c, l), 31), i = m(i = v(i = y(i, c = h(c, s)), 27), a), i = m(h(i, [0, 5]), [0, 1390208809]), u = v(u = h(u, s), 33), a = m(a = v(a = y(a, u = h(u, l)), 31), i), a = m(h(a, [0, 5]), [0, 944331445]);
            switch (c = [0, 0], u = [0, 0], r) {
                ...
                case 9:
                    u = h(u = y(u, [0, e.charCodeAt(n + 8)]), s), a = y(a, u = h(u = v(u, 33), l));
                case 8:
                ...
                case 1:
                    c = h(c = y(c, [0, e.charCodeAt(n)]), l), i = y(i, c = h(c = v(c, 31), s))
            }
            return i = m(i = y(i, [0, e.length]), a = y(a, [0, e.length])), a = m(a, i), i = m(i = b(i), a = b(a)), a = m(a, i), ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[1] >>> 0).toString(16)).slice(-8)
        }(function (e) {
                    ...
                    case 0:
                        return u && function () {
                            if (!(window.__fpjs_d_m || Math.random() >= .001)) try {
                                ...
                                e.open("get", "https://m1.openfpcdn.io/fingerprintjs/v" + c.a + "/npm-monitoring", !0), e.send()
                            } catch (t) {
                                console.error(t)
                            }
                        }(), [4, ae(n)];
                    case 1:
                        return e.sent(), [2, ce(C(ne, {
                            debug: r
                        }, []), r)]
                }
            }))
    ...
    function se(e) {
        ...
        if (c.appendChild(fe(r)), i && c.classList.add(i), t.appendChild(c), o) {
    ...
    function de(e) {
        ...
        t instanceof HTMLButtonElement && (t.disabled = !1, t.addEventListener("click", (function (t) {
            t.preventDefault(),
                function (e) {
        ...
        n instanceof HTMLButtonElement && (n.disabled = !1, n.addEventListener("click", (function (t) {
            t.preventDefault(),
                function (e) {
                    o(this, void 0, void 0, (function () {
                        return i(this, (function (t) {
                            switch (t.label) {
                                case 0:
                                    if (!navigator.share) return alert("Sharing is unavailable.\n\nSharing is available in mobile browsers and only on HTTPS websites. " + ("https:" === location.protocol ? "Use a mobile device or the Copy button instead." : "Open https://" + location.host + location.pathname + location.search + " instead.")), [2];
                                    t.label = 1;
                                case 1:
    ...
    function fe(e) {
        ...
        t.innerHTML = e.html;
        for (var n = document.createDocumentFragment(); t.firstChild;) n.appendChild(t.firstChild);
        return n
    }! function () {
        o(this, void 0, void 0, (function () {
            ...
            return i(this, (function (i) {
                switch (i.label) {
                    case 0:
                        if (!(e = document.querySelector(".output"))) throw new Error("The output element isn't found in the HTML code");
                        t = Date.now(), i.label = 1;
                    case 1:
                        return i.trys.push([1, 3, , 4]), [4, le()];
                    case 2:
                        return n = i.sent(), r = n.visitorId, o = n.confidence, a = n.components, u = Date.now() - t, e.innerHTML = "", se({
                            output: e,
                            ...
                            comment: o.comment && {
                                html: o.comment.replace(/(upgrade\s+to\s+)?pro(\s+version)?(:\s+(https?:\/\/\S+))?/gi, '<a href="$4" target="_blank">$&</a>')
                            },
                            size: "big"
                        }), se({
                            output: e,
                            ...
                            content: oe(a)
                        }), de("Visitor identifier: `" + r + "`\nTime took to get the identifier: " + u + "ms\nConfidence: " + JSON.stringify(o) + "\nUser agent: `" + navigator.userAgent + "`\nEntropy components:\n```\n" + oe(a) + "\n```"), [3, 4];
                    case 3:
                        throw c = i.sent(), u = Date.now() - t, l = g(c), e.innerHTML = "", se({
                            output: e,
